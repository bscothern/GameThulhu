...
public class GameControllerDiscovery {
    /**
     ...
     - parameters:
        - controller: The controller which has just had its connection status change.
     */
    ...
    /**
     ...
     - parameters:
        - callback: The function that should be called when a new controller is found by the system.
    ...
    /**
     ...
     - parameters:
        - observer: An `Observer` received from a call to `observeControllerConnected()` that is used to unobserve connection events.
     */
    ...
    /**
     ...
     - parameters:
        - callback: The function that should be called when a controller is disconnected from the system.
    ...
    /**
     ...
     - parameters:
        - observer: An `Observer` received from a call to `observeControllerDisconnected()` that is used to unobserve disconnection events.
     */
